...
class GoodsCategory(models.Model):
    ...
    category_type = models.IntegerField(choices=CATAGORY_TYPE, verbose_name="类目级别", help_text="类目级别")
...
class GoodsCategoryBrand(models.Model):
    ...
    品牌名
    """
    category = models.ForeignKey(GoodsCategory, on_delete=models.SET_NULL,related_name="brands", null=True, blank=True, verbose_name="商品类目")
